...
function transformUnit(sitelinkUnit) {
	...
	return {
		...
		unitType: {
			...
			excludeFromAutoTenRateMgmt: parseBoolean(sitelinkUnit.bExcludeFromAutoTenRateMgmt),
			excludeFromRevenueMgmt: parseBoolean(sitelinkUnit.bExcludeFromRevenueMgmt),
			showOnReservations: parseBoolean(sitelinkUnit.bShowOnReservations),
			excludeFromInsurance: parseBoolean(sitelinkUnit.bExcludeFromInsurance),
			excludeFromOccupancy: parseBoolean(sitelinkUnit.bExcludeFromOccupancy),
			excludeFromArea: parseBoolean(sitelinkUnit.bExcludeFromArea),
			vacateNoticeDays: parseInt(sitelinkUnit.iVacateNoticeDays),
			vacateNoticeGraceDays: parseInt(sitelinkUnit.iVacateNoticeGraceDays),
			waitingListReserved: parseBoolean(sitelinkUnit.bWaitingListReserved),
